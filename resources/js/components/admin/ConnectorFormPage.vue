...
const activeTab = ref(props.errors.length ? 'general' : 'general');
...
const schemaFields = ref((props.connector?.config_schema ?? []).map(f => ({ ...defaultField(), ...f })));
...
.tab-btn:hover { color: #d1d5db; background: rgba(239,68,68,0.04); }
.tab-btn.active {
  background: rgba(24,10,10,0.6); color: #fca5a5;
  border-color: rgba(239,68,68,0.1); border-bottom-color: rgba(24,10,10,0.6);
}

.form-card {
  background: rgba(24,10,10,0.6); border: 1px solid rgba(239,68,68,0.1);
  border-radius: 0 0.75rem 0.75rem 0.75rem; padding: 1.75rem; max-width: 700px;
  border-top: none;
}
...
.form-actions { display: flex; gap: 0.75rem; align-items: center; margin-top: 1.75rem; }
.btn-submit {
...
.schema-input { flex: 1; min-width: 100px; padding: 0.45rem 0.6rem; background: rgba(12,4,4,0.8); border: 1px solid rgba(239,68,68,0.15); border-radius: 0.4rem; color: #e5e7eb; font-size: 0.85rem; font-family: inherit; width: auto; }
...
.schema-select { padding: 0.45rem 0.6rem; background: rgba(12,4,4,0.8); border: 1px solid rgba(239,68,68,0.15); border-radius: 0.4rem; color: #e5e7eb; font-size: 0.85rem; font-family: inherit; flex-shrink: 0; width: auto; }
